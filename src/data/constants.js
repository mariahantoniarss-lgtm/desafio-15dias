export const STORAGE_KEY_V2 = 'desafio_friends_v2_nivel2';
export const STORAGE_KEY = 'rotina_friends_v3';

export const ITENS_CHECKLIST = [
  { id: 'stories', label: 'Publiquei pelo menos 10 Stories' },
  { id: 'interacao', label: 'Fiz pelo menos 2 interações nos Stories' },
  { id: 'mensagens', label: 'Respondi comentários e mensagens' },
  { id: 'conversas', label: 'Iniciei pelo menos 3 conversas' },
  { id: 'friends', label: 'Comentei em 2 perfis de Friends' },
  { id: 'comercial', label: 'Fiz pelo menos 1 ação comercial' },
];
